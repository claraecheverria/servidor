...
public interface ReservaRepository extends CrudRepository<Reserva,Long> {
    ...
    List<Reserva> findByUserEmplCreador_EmailAndFechaAndCancha_Key_NombreAndCancha_Key_CentroDeportivo(String email, LocalDate fecha, String nombre, String centroDeportivo);
